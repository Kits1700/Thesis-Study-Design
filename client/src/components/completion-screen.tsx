...
export default function CompletionScreen() {
  const { participantId, completedTasks, questionnaireResponses } =
    useStudyStore();
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">
            Thank you for participating in this research study. Your data has
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardContent className="p-6">
              ...
              <p className="text-gray-300 text-sm">
                Your contributions help advance our understanding of AI-human
                collaboration. You may now close this window.
              </p>
            </CardContent>
          </Card>
        </div>
